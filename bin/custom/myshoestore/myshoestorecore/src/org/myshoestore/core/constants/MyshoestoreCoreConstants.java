 ...
 */
package org.myshoestore.core.constants;

/**
 * Global class for all MyshoestoreCore constants. You can add global constants for your extension into this class.
 */
public final class MyshoestoreCoreConstants extends GeneratedMyshoestoreCoreConstants
{
	public static final String EXTENSIONNAME = "myshoestorecore";


	private MyshoestoreCoreConstants()
	{
		//empty
	}
