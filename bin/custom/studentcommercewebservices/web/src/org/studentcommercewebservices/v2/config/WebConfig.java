 ...
 */
package org.studentcommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import org.studentcommercewebservices.constants.YcommercewebservicesConstants;
import org.studentcommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "studentcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "studentcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "studentcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "studentcommercewebservices.v2.description";
	private static final String TITLE = "studentcommercewebservices.v2.title";
	private static final String VERSION = "studentcommercewebservices.v2.version";
	private static final String LICENSE = "studentcommercewebservices.v2.license";
	private static final String LICENSE_URL = "studentcommercewebservices.v2.license.url";
